...
import { getCurrentBreakpoint, getGlobalContent, getMenuItems, isMenuOpen, getPage } from '../selectors'
...
class Menu extends Component {
  ...
  setMenuRef = (ref) => { this.ref = ref }
  setOverlayRef = (ref) => { this.overlayRef = ref }
          ...
          <ul className={classes.list} ref={this.setListRef}>
            {menu.map((x, i) => {
                  ...
                  <li key={i} >
                    {
                      <div className={classes.dropdown} >
                        {
                          x.menu_title === 'Home' && <Link className={classes.dropbtn} to={x.menu_link.url}><span><Symbol icon={house} className={classes.chevronDoubleRight} />{x.menu_title}</span></Link>
                        }
                        {
                          x.menu_title === 'About Us' && <Link className={classes.dropbtn} to={x.menu_link.url}><span><Symbol icon={star} className={classes.chevronDoubleRight} />{x.menu_title}</span></Link>
                        }
                        {
                          x.menu_title === 'Our Technology' && <Link className={classes.dropbtn} to={x.menu_link.url}><span><Symbol icon={handUp} className={classes.chevronDoubleRight} />{x.menu_title}</span></Link>
                        }
                        {
                          x.menu_title === 'Our Team' && <Link className={classes.dropbtn} to={x.menu_link.url}><span><Symbol icon={people} className={classes.chevronDoubleRight} />{x.menu_title}</span></Link>
                        }
                        {
              ...
              if (x.menu_type === 'dropdown') {
                if (x.menu_title === x.dropdown_parent_title && x.menu_title === 'Applications') {
                  return (
                    <li key={i} >
                      {
                        <div className={classes.dropdown}>
                          <a className={classes.dropbtn}><span><Symbol icon={tablet} className={classes.chevronDoubleRight} />Applications</span></a>
                          <div className={classes.dropdownContent}>
                            <Link className={classes.test} to={'/page/applications-potable-use'}><span>Potable Use</span></Link>
              ...
              if (x.menu_title === x.dropdown_parent_title && x.menu_title === 'Industries') {
                return (
                  <li key={i} >
                    {
                      <div className={classes.dropdown}>
                        <a className={classes.dropbtn}><Symbol icon={barChat} className={classes.chevronDoubleRight} />Industries</a>
                        <div className={classes.dropdownContent}>
                          <Link className={classes.test} to={'/page/industries-municipal'}><span>Municipal</span></Link>
                          <Link className={classes.test} to={'/page/industries-commercial'}><span>Commercial</span></Link>
                          <Link className={classes.test} to={'/page/industries-infrastructure'}><span>Infrastructure</span></Link>
                          <Link className={classes.test} to={'/page/industries-mining'}><span>Mining</span></Link>
...
const mapDispatchToProps = (dispatch) => {
  return {
    onHideMenu: () => { dispatch(toggleMenu()) }
  }
}
